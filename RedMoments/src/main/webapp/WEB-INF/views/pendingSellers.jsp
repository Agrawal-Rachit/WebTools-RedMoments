	...
	<table border="1" cellpadding="2" cellspacing="2">
		...
		<c:forEach var="user" items="${users}">
			...
			<tr>
                            ...
                            <td>${user.usertype}</td>
                            <td>${user.active}</td>
                            <td><button value="remove" class="btn btn-danger btn-lg" type="submit">Approve</button></td>
                            <td><a href="${contextPath}/admin/reject/${user.personID}.htm"><button class="btn btn-danger btn-lg" type="button">Reject</button></a></td>
			</tr>
                        </form>
